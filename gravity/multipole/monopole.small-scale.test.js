 ...
 */
test('monopole-kernels.small-scale: single particle at rest remains stationary', async () => {
 ...
 */
test('monopole-kernels.small-scale: two particles attract each other', async () => {
  const { canvas, gl } = createTestCanvas();
 ...
 */
test('monopole-kernels.small-scale: three-body equilateral triangle maintains shape', async () => {
  const { canvas, gl } = createTestCanvas();
 ...
 */
test('monopole-kernels.small-scale: ten particles in cluster contract inward', async () => {
  const { canvas, gl } = createTestCanvas();
