...
void main() {
  ...
  // Skip any children with NaN mass values
  fragA0 = vec4(0.0);
  fragA1 = vec4(0.0);
  fragA2 = vec4(0.0);
  
  if (!isnan(a0_000.w)) fragA0 += a0_000;
  if (!isnan(a0_001.w)) fragA0 += a0_001;
  if (!isnan(a0_010.w)) fragA0 += a0_010;
  if (!isnan(a0_011.w)) fragA0 += a0_011;
  if (!isnan(a0_100.w)) fragA0 += a0_100;
  if (!isnan(a0_101.w)) fragA0 += a0_101;
  if (!isnan(a0_110.w)) fragA0 += a0_110;
  if (!isnan(a0_111.w)) fragA0 += a0_111;
  
  if (!isnan(a1_000.w)) fragA1 += a1_000;
  if (!isnan(a1_001.w)) fragA1 += a1_001;
  if (!isnan(a1_010.w)) fragA1 += a1_010;
  if (!isnan(a1_011.w)) fragA1 += a1_011;
  if (!isnan(a1_100.w)) fragA1 += a1_100;
  if (!isnan(a1_101.w)) fragA1 += a1_101;
  if (!isnan(a1_110.w)) fragA1 += a1_110;
  if (!isnan(a1_111.w)) fragA1 += a1_111;
  
  if (!isnan(a2_000.w)) fragA2 += a2_000;
  if (!isnan(a2_001.w)) fragA2 += a2_001;
  if (!isnan(a2_010.w)) fragA2 += a2_010;
  if (!isnan(a2_011.w)) fragA2 += a2_011;
  if (!isnan(a2_100.w)) fragA2 += a2_100;
  if (!isnan(a2_101.w)) fragA2 += a2_101;
  if (!isnan(a2_110.w)) fragA2 += a2_110;
  if (!isnan(a2_111.w)) fragA2 += a2_111;
}`;
