...
import { ParticleSystemMeshMonolithic } from './gravity-mesh/particle-system-mesh.js';
import { ParticleSystemMonopoleMonolithic } from './gravity-monopole/particle-system-monopole.js';
import { ParticleSystemQuadrupoleMonolithic } from './gravity-quadrupole/particle-system-quadrupole.js';
import { ParticleSystemSpectralMonolithic } from './gravity-spectral/particle-system-spectral.js';
 ...
 *   step_Debug?: () => any,
 *   _system: import('./gravity-quadrupole/particle-system-quadrupole.js').ParticleSystemQuadrupoleMonolithic | import('./gravity-monopole/particle-system-monopole.js').ParticleSystemMonopoleMonolithic | import('./gravity-spectral/particle-system-spectral.js').ParticleSystemSpectralMonolithic | import('./gravity-mesh/particle-system-mesh.js').ParticleSystemMeshMonolithic,
...
export function particleSystemMonolithic({
  ...
  /** @type {ParticleSystemQuadrupoleMonolithic | ParticleSystemMonopoleMonolithic | ParticleSystemSpectralMonolithic | ParticleSystemMeshMonolithic} */
  let system;

  switch (method) {
    case 'mesh': {
      system = new ParticleSystemMeshMonolithic(gl, {
        particleCount,
        particleData: {
          positions,
          velocities,
    ...
    case 'spectral': {
      system = new ParticleSystemSpectralMonolithic(gl, {
        particleCount,
        particleData: {
          positions,
          velocities,
    ...
    case 'monopole': {
      system = new ParticleSystemMonopoleMonolithic(gl, {
        particleCount,
        particleData: {
          positions,
          velocities,
    ...
    case 'quadrupole':
    default: {
      system = new ParticleSystemQuadrupoleMonolithic(gl, {
        particleCount,
        particleData: {
          positions,
          velocities,
...
/**
 * @param {Pick<Parameters<typeof particleSystemMonolithic>[0], 'particles' | 'get'> & {
