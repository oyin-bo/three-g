...
import { particleSystemMonolithic } from "./particle-system-monolithic.js";

// Import PM/FFT pipeline verifiers (statically, not dynamically)
import * as pmVerifiers from "./gravity-spectral/debug/pm-pipeline-verifiers.js";
...
import {
  ...
  generateGridGraph,
  generateTreeGraph,
} from "./utils/social-graph-generator.js";
...
/** @type {ReturnType<typeof particleSystemMonolithic> | null} */
let physics = null;
...
function recreatePhysicsAndMesh() {
  ...
  const physics = particleSystemMonolithic(baseOptions);
