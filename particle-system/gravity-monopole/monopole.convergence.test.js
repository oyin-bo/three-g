 ...
 */
test('monopole.convergence: smaller timestep improves accuracy', async () => {
 ...
 */
test('monopole.convergence: theta parameter controls approximation quality', async () => {
 ...
 */
test('monopole.convergence: softening affects close encounters', async () => {
