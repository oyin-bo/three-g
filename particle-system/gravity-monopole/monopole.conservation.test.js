 ...
 */
test('monopole.conservation: energy approximately conserved over time', async () => {
 ...
 */
test('monopole.conservation: momentum conserved in isolated system', async () => {
  const { canvas, gl } = createTestCanvas();
 ...
 */
test('monopole.conservation: angular momentum conserved in rotating system', async () => {
  const { canvas, gl } = createTestCanvas();
