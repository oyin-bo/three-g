 ...
 */
test('monopole.stability: high velocity particles remain stable', async () => {
 ...
 */
test('monopole.stability: very small timestep produces stable results', async () => {
  const { canvas, gl } = createTestCanvas();
 ...
 */
test('monopole.stability: large timestep handled without crash', async () => {
  const { canvas, gl } = createTestCanvas();
 ...
 */
test('monopole.stability: handles single and minimal particle counts', async () => {
  const { canvas, gl } = createTestCanvas();
